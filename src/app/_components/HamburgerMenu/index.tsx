    ...
    <div className="relative z-[60]">
      ...
      {(isOpen || isClosing) && (
        ...
        >
          ...
          ></div>
          <div className="border-0 border-r-2 border-solid border-customWhite w-1/6 h-full flex flex-col justify-between items-center bg-secondary bg-opacity-50 z-50">
